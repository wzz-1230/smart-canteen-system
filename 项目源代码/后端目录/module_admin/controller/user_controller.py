...
async def query_detail_system_user_profile(
    ...
    try:
        ...
        logger.warning(f'获取用户个人信息失败: {e}')
        return ResponseUtil.failure(msg='获取个人信息失败，请稍后重试')
...
async def change_system_user_profile_info(
    ...
    try:
        ...
        logger.warning(f'修改用户个人信息失败: {e}')
        try:
            await query_db.rollback()
        except Exception:
            pass
        return ResponseUtil.failure(msg='修改信息失败，请稍后重试')
...
async def reset_system_user_password(
    ...
    try:
        ...
        try:
            ...
            pass
        return ResponseUtil.failure(msg=str(e) if hasattr(e, 'message') else '修改密码失败，请稍后重试')
