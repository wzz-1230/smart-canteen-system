...
class UploadSettings:
    ...
    # 食堂菜品本地图片目录（以菜名命名的图片文件放在此目录）
    CANTEEN_MENU_IMAGE_PATH = 'static/canteen-menu-images'
    CANTEEN_MENU_IMAGE_PREFIX = '/static/canteen-menu-images'
    # AI 生成的菜品图片保存目录
    CANTEEN_MENU_AI_IMAGE_PATH = 'static/canteen-menu-images/ai'
    CANTEEN_MENU_IMAGE_EXTS = ['.jpg', '.jpeg', '.png', '.webp', '.gif']
    UPLOAD_MACHINE = 'A'
    ...
    def __init__(self) -> None:
        ...
        if not os.path.exists(self.CANTEEN_MENU_IMAGE_PATH):
            os.makedirs(self.CANTEEN_MENU_IMAGE_PATH, exist_ok=True)
        if not os.path.exists(self.CANTEEN_MENU_AI_IMAGE_PATH):
            os.makedirs(self.CANTEEN_MENU_AI_IMAGE_PATH, exist_ok=True)
